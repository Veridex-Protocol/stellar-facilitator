...
| Provider outcomes | Signed response digest/payTo/resource-bound outcome extension; source is persisted as in-band or independent and disagreements are recorded | Live observations and deterministic extension/source/disagreement tests; migration `006` | Implemented/tested; quality service remains early |
...
| Migrations | Automatic Bazaar migration runner; six tracked migrations | Empty database applied the first four in prior clean run; migrations `005/006` are locally tested but lack a captured destructive clean-stack run | Baseline proven; latest migrations implemented/tested |
...
The 2026-09-06 `36/36` run is the latest testnet ledger evidence and includes exact transaction `4b36d1f406fb1560c9e61873c911fd71a26f9408f2ffbaf24239259f65cdee08` at ledger `4539054`, direct `upto` partial `b4b474d151de351b84e9af1a6c39e8145d33481ff3f741300f2dec631c1a3142` at ledger `4539058`, and zero `638b71e6dddd4dd0e214355b998ffda28e79c042f091655aa2b03d3dc421e2bf` at ledger `4539060`. It was run against the fresh stack but is not a newly captured destructive empty-volume bootstrap for migrations `005/006`. `federation` remains a prototype, `upto` remains experimental and unaudited, the deployed smart-account proof remains absent, and no pubnet/mainnet or production-readiness claim is made.
