...
| Pay an HTTP x402 Stellar resource | `@veridex/stellar` `createVeridexClient()` or official `@x402/fetch` plus `@x402/stellar` | Canonical buyer path; Veridex package pending npm publication |
